...
On va comparer ce paramètre avec une estimation ponctuelle, afin de savoir si l'affirmation du fabricant est vraie. Pour cela nous allons réaliser le test du point de vue client.
...
Oon ne rejette pas l'hypothèse $H_0$ jusqu'à preuve du contraire.

Jusqu'à preuve du contraire, la garantie du fabricant est vraie.

Dans notre cas le client acceptera le lot si le nombre de pièces défectueuses dans le lot est conforme à l’affirmation du fabricant, donc le client acceptera le lot.
