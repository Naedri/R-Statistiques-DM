...
Pour $x$ donné, on suppose qu'il est pertinent de représenter cette mesure par une variable aléatoire $Y = \theta x^2 + aZ$, $a$ ($a>0$) connu, $\theta$ ($\theta \in \mathbb{R}$) inconnu,  $Z$ une variable aléatoire ($Z \leadsto N(0,1)$).
