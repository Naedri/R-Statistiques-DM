...
Pour estimer le paramètre $\theta$, on fait $n(n \ge 1)$ essais indépendants avec des doses $X_1, \ldots X_n$ données de l’agent $A$. On extrait donc un échantillon aléatoire bernoullien $Y_n$ de $Y$ .
...
Le graphique, ci dessous illustre le modèle aléatoire suivant $Y = \theta x^2 + aZ$  soulignant la relation linéaire entre $Y$ et $x²$ :
